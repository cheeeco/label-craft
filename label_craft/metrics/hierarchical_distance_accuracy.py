...
class HierarchicalDistanceAccuracy:
    """
    Hierarchical Distance Accuracy (HDA) metric that considers category tree structure.
    
    The metric gives partial credit for predictions that are close in the category hierarchy.
    """
